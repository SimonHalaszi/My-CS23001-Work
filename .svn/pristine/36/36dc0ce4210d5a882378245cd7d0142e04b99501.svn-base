...
int main () {
    ...
    }
    {
        //------------------------------------------------------
        // Setup fixture
        std::cout << "-     Test 8 (Weirdness): " << std::endl;        
        ...
        subString = string.substr(2 , 0);
        assert(subString == '\0');
        std::cout << "Substring(2, 0): " << '"' << subString << '"' << std::endl;

        subString = string.substr(-2 , 10);
        assert(subString == '\0');
        std::cout << "Substring(-2, 10): " << '"' << subString << '"' << std::endl;

        subString = string.substr(2 , -10);
        assert(subString == '\0');
        std::cout << "Substring(2, -10): " << '"' << subString << '"' << std::endl;

        subString = string.substr(-2 , -1);
        assert(subString == '\0');
        std::cout << "Substring(-2, -1): " << '"' << subString << '"' << std::endl;
    }
    {
        //------------------------------------------------------
        // Setup fixture
        ...
        subString = emptyString.substr(2 , 0);
        assert(subString == '\0');
        std::cout << "Substring(2, 0): " << '"' << subString << '"' << std::endl;
    }  
    {
